import {
  RemoteAddAccount,
  RemoteAddAccountNamespace,
} from './RemoteAddAccount';
...
describe('RemoteAddAccount', () => {
  ...
  test('Should return an AccountModel if HttpClient returns 201', async () => {
    ...
    const account = await systemUnderTest.add(mockAddAccount());
