...
type SutTypes = {
  sut: RemoteLoadUserFollowingList
  httpClientSpy: HttpClientSpy<RemoteLoadUserFollowingList.Model[]>
}

const makeSut = (url = faker.internet.url()): SutTypes => {
  const httpClientSpy = new HttpClientSpy<RemoteLoadUserFollowingList.Model[]>()
  const sut = new RemoteLoadUserFollowingList(url, httpClientSpy)
  return {
    sut,
    httpClientSpy
  }
